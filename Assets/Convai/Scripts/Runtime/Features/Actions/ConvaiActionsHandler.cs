...
namespace Convai.Scripts.Runtime.Features
{
    ...
    public class ConvaiActionsHandler : MonoBehaviour
    {
        ...
        public IEnumerator MoveTo(GameObject target)
        {
            ...
            if (target.TryGetComponent(out TriggerActivator triggerActivator))
            {
                triggerActivator.ActivateTrigger();
                _uiAppearanceSettings.TempHideUI();
            }
        ...
        {
            animator.CrossFadeInFixedTime(Animator.StringToHash("Walking"), 0.5f);
        ...
        private Vector3 CalculateTargetDestination(GameObject target)
        {
            ...
            {
                targetDestination += 0.05f * target.transform.forward;
            }
        ...
        {
            animator.CrossFadeInFixedTime(Animator.StringToHash("Idle"), 0.45f);
